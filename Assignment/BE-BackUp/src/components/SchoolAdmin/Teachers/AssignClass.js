...
import { Common, VALIDATION } from "../../../helper";
        ...
        >
            {({
                ...
                <Form onSubmit={handleSubmit} style={styles.modal_form}>
                    <Form.Group>
                        <label for="Class">{Common.Class} </label>
                        <Select
                        ...
                        />
                        {errMessage && (<small className="text-danger">{VALIDATION.PLEASE_SELECT_A_CLASS}</small>)}
                    </Form.Group>

                    <Form.Group style={styles.radioMargin}>
                        <label for="Subjects">{Common.Subjects} </label>
                        ...
                        />
                        {errMessage1 && (<small className="text-danger">{VALIDATION.PLEASE_SELECT_A_SUBJECT}</small>)}
                    </Form.Group>
